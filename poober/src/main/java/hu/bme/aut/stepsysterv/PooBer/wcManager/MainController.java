...
/**
 * Controller for non user and invoice related tasks.
 */
@Controller
...
public class MainController {
	...
	/**
	 *Reserves wc for authenticated user
	 */
	...
	/**
	 *Called by the raspberry pi, when the door is opened. The first open after reservation
	 * is considered the entry, the second is considered the user's exit, after which an invoice is
	 * created.
	 */
